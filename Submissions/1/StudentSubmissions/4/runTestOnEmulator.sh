...
ANDROID_SERIAL="$1" gradle connectedDebugAndroidTest -Pandroid.testInstrumentationRunnerArguments.numShards="$2" -Pandroid.testInstrumentationRunnerArguments.shardIndex="$3" 2> $rootDir/log.txt
